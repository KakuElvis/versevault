...
const Hero = () => {
  return (
    <section id="hero" className="bg-[#176183]/90 text-white pt-28 pb-20 px-6 md:px-20">
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <div className="space-x-4">
            <Link to="/signin" className="bg-button-main text-white px-6 py-3 rounded font-bold hover:opacity-80">Join</Link>
